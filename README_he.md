...
Matrix Website היא אפליקציית React ממוקדת Frontend עם זהות ויזואלית חזקה בהשראת *The Matrix*.  
הפרויקט מדגיש **ארכיטקטורה מבוססת קומפוננטות**, **תנועה ואפקטים**, ו־**פיצ’רים מוכווני משתמש** כגון תצוגת תוכן וייצוא לקובץ PDF.
